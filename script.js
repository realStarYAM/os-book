...
const SCENARIO = [
    ...
    // ========================================
    // ARC 5 — CHAPITRE 3 : LA PERTE DE CONTRÔLE
    // La corruption devient dangereuse
    // Le Kernel perd son emprise
    // ========================================
    ...
    // 🌑 Scène 1 — La fissure s'élargit
    {
        scene: 'void',
        speaker: 'narrator',
        text: "🌑 La fissure s'élargit. Le silence devient lourd.",
        emotion: 'normal',
        characters: { left: null, center: null, right: null },
        mood: 'mysterious',
        divineBg: true,
    ...
    // 🌑 Scène 3 — Windows 11 perçoit
    {
        scene: 'void',
        speaker: 'windows11',
        text: "😟 Le noyau perd sa stabilité.",
        emotion: 'serious',
        characters: { left: 'windows11', center: null, right: null },
        futuristicBg: true
    },

    // 🌑 Scène 4 — Ubuntu alerte
    {
        scene: 'void',
        speaker: 'ubuntu',
        text: "🐧⚠️ La corruption nous frôle.",
        emotion: 'worried',
        characters: { left: null, center: null, right: 'ubuntu' },
        linuxBg: true
    },

    // 🌑 Scène 5 — Présence invisible
    {
        scene: 'void',
        speaker: 'narrator',
        text: "👁️ Une présence invisible traverse le vide.",
        emotion: 'normal',
        characters: { left: null, center: null, right: null },
        afterlifeBg: true,
        glitchDark: true,
    ...
    // 🌑 Scène 6 — ChromeOS sans visage
    {
        scene: 'void',
        speaker: 'chromeos',
        text: "😈 Je suis encore là.",
        emotion: 'villain',
        characters: { left: null, center: null, right: null },
        villainMode: true,
        echoVoice: true,
    ...
    // 🌑 Scène 7 — Verrouillage
    {
        scene: 'void',
        speaker: 'narrator',
        text: "🔒 Le Kernel tente un verrouillage.",
        emotion: 'normal',
        characters: { left: null, center: 'kernel', right: null },
        divineBg: true,
    ...
    // 🌑 Scène 8 — Windows 11 craque
    {
        scene: 'void',
        speaker: 'windows11',
        text: "😰 Ça ne tient plus.",
        emotion: 'fear',
        characters: { left: 'windows11', center: null, right: null },
        futuristicBg: true,
        shake: true
    ...
    // 🌑 Scène 9 — Ubuntu confirme
    {
        scene: 'void',
        speaker: 'ubuntu',
        text: "🐧 Si le Kernel chute, tout s'effondre.",
        emotion: 'serious',
        characters: { left: null, center: null, right: 'ubuntu' },
        linuxBg: true
    },

    // 🌑 Scène 10 — La corruption mord
    {
        scene: 'void',
        speaker: 'narrator',
        text: "🩸 La corruption mord la lumière.",
        emotion: 'normal',
        characters: { left: null, center: 'kernel', right: null },
        mood: 'chaotic',
        divineBg: true,
    ...
    // 🌑 Scène 11 — Le Kernel lâche prise
    {
        scene: 'void',
        speaker: 'kernel',
        text: "Je perds... la main.",
        emotion: 'divine',
        characters: { left: null, center: 'kernel', right: null },
        divineBg: true,
        divineVoice: true,
    ...
    // 🌑 Scène 13 — Onde de douleur
    {
        scene: 'void',
        speaker: 'narrator',
        text: "⚡ Une douleur traverse les systèmes.",
        emotion: 'normal',
        characters: { left: null, center: null, right: null },
        afterlifeBg: true,
        shake: true,
    ...
    // 🌑 Scène 15 — Fin du chapitre
    {
        scene: 'void',
        speaker: 'narrator',
        text: "⚠️ Le Kernel tient... mais le contrôle lui échappe.",
        emotion: 'normal',
        characters: { left: null, center: 'kernel', right: null },
        divineBg: true,
        kernelFlicker: true,
    ...
    // ========================================
    // ARC 5 — CHAPITRE 7 : LE MONDE TREMBLE
    // Fin intense : le monde libre vacille, bascule vers l’Arc 6
    // ========================================
    ...
    // 🌪️ Scène 1 — Le silence se déchire
    {
        scene: 'void',
        speaker: 'narrator',
        text: "Le monde libre se fissure. Le silence devient menace.",
        emotion: 'normal',
        characters: { left: null, center: null, right: null },
        mood: 'dramatic',
        afterlifeBg: true,
    ...
    // 🌪️ Scène 2 — Corruption brutale
    {
        scene: 'void',
        speaker: 'narrator',
        text: "La corruption monte d’un bond. Tout vacille.",
        emotion: 'normal',
        characters: { left: null, center: null, right: null },
        mood: 'chaotic',
        codeCorrupt: true,
        afterlifeBg: true,
        corruptionIncrease: 16,
        sfx: { category: 'attacks', sound: 'chromeos_corruption', volume: 0.45 }
    },

    // 🌪️ Scène 3 — Ubuntu plie
    {
        scene: 'void',
        speaker: 'ubuntu',
        text: "🐧 Je tiens… mais chaque ligne se brise.",
        emotion: 'hurt',
        characters: { left: null, center: null, right: 'ubuntu' },
        linuxBg: true
    },

    // 🌪️ Scène 4 — Menace à distance
    {
        scene: 'void',
        speaker: 'narrator',
        text: "Au loin, une force glisse dans le réseau.",
        emotion: 'normal',
        characters: { left: null, center: null, right: null },
        mood: 'dramatic',
        afterlifeBg: true,
    ...
    // 🌪️ Scène 5 — ChromeOS sans visage
    {
        scene: 'void',
        speaker: 'chromeos',
        text: "😈 Je n’ai pas besoin d’être là pour vous atteindre.",
        emotion: 'villain',
        characters: { left: 'chromeos', center: null, right: null },
        villainMode: true,
        afterlifeBg: true,
    ...
    // 🌪️ Scène 6 — Défenses en rupture
    {
        scene: 'void',
        speaker: 'narrator',
        text: "La menace devient tangible. Les défenses s’effondrent.",
        emotion: 'normal',
        characters: { left: null, center: null, right: null },
        mood: 'chaotic',
        afterlifeBg: true,
    ...
    // 🌪️ Scène 7 — Douleur
    {
        ...
        characters: { left: null, center: null, right: 'ubuntu' },
        linuxBg: true,
        sfx: { category: 'pain', sound: 'digital_pain', volume: 0.4 }
    },

    // 🌪️ Scène 8 — Le noyau écoute
    {
        scene: 'void',
        speaker: 'narrator',
        text: "Le Kernel écoute. Il approche.",
        emotion: 'normal',
        characters: { left: null, center: null, right: null },
        mood: 'dramatic',
        divineBg: true,
    ...
    // 🌪️ Scène 10 — Ubuntu à genoux
    {
        scene: 'void',
        speaker: 'narrator',
        text: "Ubuntu vacille. Le sol numérique s’ouvre sous lui.",
        emotion: 'normal',
        characters: { left: null, center: null, right: 'ubuntu' },
        mood: 'dramatic',
        linuxBg: true
    ...
    // 🌪️ Scène 11 — Serment brisé
    {
        scene: 'void',
        speaker: 'ubuntu',
        text: "🐧 Si je tombe… le monde tombe.",
        emotion: 'determined',
        characters: { left: null, center: null, right: 'ubuntu' },
        linuxBg: true
    },

    // 🌪️ Scène 12 — Verrouillage
    {
        scene: 'void',
        speaker: 'narrator',
        text: "Alerte. Le monde libre se fige.",
        emotion: 'normal',
        characters: { left: null, center: null, right: null },
        mood: 'chaotic',
        afterlifeBg: true,
        sfx: { category: 'lockdown', sound: 'system_lockdown', volume: 0.45 }
    },

    // 🌪️ Scène 13 — Intervention annoncée
    {
        scene: 'void',
        speaker: 'narrator',
        text: "Le Kernel va intervenir. C’est inévitable.",
        emotion: 'normal',
        characters: { left: null, center: null, right: null },
        mood: 'dramatic',
        divineBg: true
    ...
    // 🌪️ Scène 14 — Fin du chapitre
    {
        scene: 'void',
        speaker: 'narrator',
        text: "Le monde tremble. L’Arc 6 attend, dans l’ombre.",
        emotion: 'normal',
        characters: { left: null, center: null, right: null },
        mood: 'dramatic',
        afterlifeBg: true,
...
class VisualNovelEngine {
    ...
    renderChapterList() {
        ...
        CHAPTERS.forEach((chapter, index) => {
            ...
            if (index === 0) {
            ...
            } else if (chapter.requiresArc5) {
                // Arc 5 Chapitre 2 se débloque quand on a atteint Arc 5
                const arc5 = CHAPTERS.find(ch => ch.id === 'arc5');
                const arc5StartIndex = arc5 ? arc5.startIndex : 602;
                isUnlocked = maxProgress >= arc5StartIndex;
            } else if (chapter.requiresArc5Ch2) {
                // Arc 5 Chapitre 3 se débloque quand on a atteint Arc 5 Chapitre 2
                const arc5Ch2 = CHAPTERS.find(ch => ch.id === 'arc5_ch2');
                ...
                // Arc 5 Chapitre 7 se débloque quand on a atteint Arc 5 Chapitre 6
            ...
            } else if (chapter.requiresArc5Ch7) {
                // Scènes Secrètes se débloquent quand on a atteint Arc 5 Chapitre 7
                const arc5Ch7 = CHAPTERS.find(ch => ch.id === 'arc5_ch7');
                const arc5Ch7StartIndex = arc5Ch7 ? arc5Ch7.startIndex : 697;
                isUnlocked = maxProgress >= arc5Ch7StartIndex;
            } else {
